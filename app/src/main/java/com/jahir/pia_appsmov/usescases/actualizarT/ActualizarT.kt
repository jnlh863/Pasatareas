...
class ActualizarT : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dato2 = bundle?.getString("nameT")
        val dato3 = bundle?.getString("materiaT")
        val dato4 = bundle?.getString("DesH")
        ...
        NombreNew.setText(dato2.toString())
        MateriaNew.setText(dato3.toString())
        DescripcionNew.setText(dato4.toString())
